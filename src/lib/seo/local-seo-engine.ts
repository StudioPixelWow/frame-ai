...
const REGIONS = [
  ...
  'רמת השרון', 'עמק חפר', 'עמק יזרעאל', 'גליל עליון', 'גליל תחתון',
  'נגב מערבי', 'ערבה', 'יהודה ושומרון', 'עוטף עזה',
];

// תבניות חיפוש מקומי ישראלי — Hebrew Local Search Patterns
const LOCAL_SEARCH_TEMPLATES = [
  // [Service] + [City]: "רואה חשבון בתל אביב"
  '{service} ב{city}',
  // [Service] + [Region]: "קידום אתרים במרכז"
  '{service} ב{region}',
  // "קרוב אליי" / "באזורי" — growing mobile pattern
  '{service} קרוב אליי',
  '{service} באזורי',
  // Neighborhood-level: "רופא שיניים בפלורנטין"
  '{service} ב{neighborhood}',
];

// GBP (Google Business Profile) optimization checklist items
const GBP_CHECKLIST = [
  'שם עסק — שם מדויק ללא keyword stuffing',
  'קטגוריה ראשית — הכי ספציפית שזמינה',
  'כתובת מלאה בעברית ואנגלית',
  'טלפון ישראלי בפורמט +972-XX-XXXXXXX',
  'שעות פתיחה — כולל חגים ישראליים (סגור בשבת)',
  'תיאור עסק (750 תווים) עם מילות מפתח טבעיות',
  'תמונות: לוגו, כיסוי, פנים, חוץ, שירותים',
  'פוסטים שבועיים עם CTA בעברית',
  'Q&A — 5-10 שאלות נפוצות מוכנות מראש',
  'ביקורות: בקשה דרך WhatsApp (הכי אפקטיבי בישראל)',
];
