...
export const TRANSITION_PRESETS: TransitionPreset[] = [
  ...
  {
    id: 'prismatic_flash_sweep',
    name: 'Prismatic Flash Sweep',
    nameHe: 'סוויפ פריזמטי',
    category: 'clean_premium',
    duration: 900,
    easing: 'ease_in_out',
    behavior: 'Premium RGB light sweep with holographic prismatic glow and white-hot core',
    cssPreview: 'trans-prismatic-sweep',
    recommendedUseCase: 'Luxury products, real estate, emotional moments, AI-native content',
    recommendedUseCaseHe: 'מוצרי יוקרה, נדל"ן, רגעים אמוציונליים, תוכן AI',
    icon: '✨',
    notes: 'Cinematic premium motion signature — system identity effect',
    isHeavy: false,
  },
  ...
  {
    id: 'prismatic_sweep_luxury',
    name: 'Prismatic Sweep Luxury',
    nameHe: 'סוויפ פריזמטי יוקרתי',
    category: 'luxury',
    duration: 1100,
    easing: 'ease_in_out',
    behavior: 'Extended prismatic flash sweep with deeper chromatic aberration and longer cinematic tail',
    cssPreview: 'trans-prismatic-luxury',
    recommendedUseCase: 'Premium visuals, luxury lifestyle, hotel/resort, high-end brand content',
    recommendedUseCaseHe: 'ויזואלים פרימיום, אורח חיים יוקרה, מלון/אתר נופש, תוכן מותג יוקרתי',
    icon: '🌟',
    notes: 'Extended version of Prismatic Flash Sweep for luxury contexts',
    isHeavy: false,
  },
