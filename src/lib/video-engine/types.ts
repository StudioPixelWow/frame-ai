...
export const TRANSITION_STYLES: { id: TransitionStyle; name: string; nameHe: string; description: string; descriptionHe: string; durationMs: number }[] = [
  ...
  { id: "spectrumImpactFlash", name: "Spectrum Impact Flash", nameHe: "פלאש ספקטרום", description: "Fullscreen cinematic RGB flash burst with chromatic aberration", descriptionHe: "פלאש קולנועי מלא מסך עם פיצוץ צבעוני כרומטי", durationMs: 1200 },
