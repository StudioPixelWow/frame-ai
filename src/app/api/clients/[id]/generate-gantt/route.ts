...
5. caption — זהו הפוסט המלא שמתפרסם ברשתות חברתיות ומלווה את הגרפיקה. חייב להיות ארוך, מעניין, יצירתי ומושך. מינימום 150 תווים. מבנה: פתיחה עם hook רגשי/פרובוקטיבי (מבוססת על ה-hook) + גוף עם ערך אמיתי/סיפור/תובנה שאנשים ירצו לקרוא (מרחיב את ה-ideaSummary) + CTA ספציפי + 3-5 האשטגים רלוונטיים. זה צריך להיות פוסט שלם שמושך engagement ושיתופים.
...
- caption: פוסט שלם ויצירתי לרשתות (150+ תווים) — hook רגשי + גוף עם ערך/סיפור + CTA + האשטגים. פוסט שאנשים ירצו לקרוא
...
[
  {
    ...
    "caption": "פוסט שלם ויצירתי לרשתות חברתיות (מינימום 150 תווים). hook רגשי/פרובוקטיבי + גוף עם ערך אמיתי/סיפור/תובנה שאנשים ירצו לקרוא + CTA ספציפי + 3-5 האשטגים. זה צריך להיות פוסט מעניין שמושך engagement",
