...
5. caption — זהו הפוסט המלא שמתפרסם ברשתות חברתיות ומלווה את הגרפיקה. חייב להיות ארוך, מעניין, יצירתי ומושך. אורך מחייב: 350-400 תווים. מבנה מחייב לפי סטנדרט ישראלי:
   שורה 1: Hook — משפט פתיחה חד שעומד לבד לפני חיתוך "עוד". שאלה/הצהרה/מספר/ניגוד.
   שורות 2-4: גוף — הקשר, סיפור, תובנה או ערך אמיתי שאנשים ירצו לקרוא.
   שורה 5: CTA — קריאה לפעולה ברורה עם ← (קישור בביו / שלחו "מעוניין" בוואטסאפ / תייגו חבר).
   שורה אחרונה: 5-10 האשטגים — מיקס עברית+אנגלית, כולל #שיווק_דיגיטלי #עסקים_בישראל + האשטגים ניש ספציפיים.
   אימוג׳ים: חובה 2-3 אימוג׳ים רלוונטיים פזורים בגוף הטקסט (לא בתחילת שורה, לא מוגזם).
   כל הגוף בעברית, שורות מופרדות בשורה ריקה בין חלקים. זה צריך להיות פוסט שלם שמושך engagement ושיתופים.
...
- caption: פוסט שלם ויצירתי לרשתות (350-400 תווים) — מבנה מחייב: שורה 1 = Hook חד (שאלה/הצהרה/מספר). שורות 2-4 = גוף עם ערך/סיפור/תובנה. שורה 5 = CTA עם ← (קישור בביו/וואטסאפ). שורה אחרונה = 5-10 האשטגים (#עברית + #english). חובה 2-3 אימוג׳ים רלוונטיים בגוף. שורות מופרדות
...
[
  {
    ...
    "caption": "פוסט שלם ויצירתי (350-400 תווים). מבנה מחייב:\nשורה 1: Hook חד — שאלה/הצהרה/מספר שעומד לבד\n\nגוף: 2-4 שורות עם ערך/סיפור/תובנה + 2-3 אימוג׳ים רלוונטיים\n\n← CTA ספציפי (קישור בביו / שלחו מעוניין בוואטסאפ)\n\n#האשטג_עברית #hashtag_english (5-10 האשטגים מיקס)",
...
function generateCaptionDeterministic(title: string, platform: string, index: number): string {
  const templates = [
    `${title}\n\nאני אגיד לכם משהו שרוב האנשים לא רוצים לשמוע — אבל צריכים 🎯\nבעולם שבו כולם עושים את אותו הדבר, ההבדל היחיד הוא איכות.\nואיכות מתחילה בבחירה — בבחירה של מי עומד מאחורי העסק שלכם, מי מוביל את השיווק, ומי באמת מבין את הקהל שלכם.\n\nאנחנו לא מאמינים בקיצורי דרך, אבל כן מאמינים בתוצאות שמדברות בעד עצמן 💪\n\nאז מה הבחירה שלכם היום?\n← שלחו לנו הודעה ונדבר על זה\n\n#עסקים #שיווק #צמיחה #שיווק_דיגיטלי #עסקים_בישראל`,
    `${title}\n\nלפני שנה חשבנו שהגענו לתקרה.\nהיום? אנחנו במקום אחר לגמרי — ולא בגלל מזל 🚀\nבגלל אסטרטגיה, עקביות, ותוצאות שמדברות בעד עצמן.\n\nמה שעשה את ההבדל? ההחלטה להפסיק לנחש ולהתחיל לעבוד עם נתונים אמיתיים. כל קמפיין, כל פוסט, כל שקל — נמדד ומותאם.\n\nרוצים לדעת איך? 🔗\n← הקישור בביו\n\n#תוצאות #צמיחהעסקית #הצלחה #שיווק_דיגיטלי #אסטרטגיה #עסקים_בישראל`,
    `${title}\n\nהנה העניין — אין קיצורי דרך.\nאבל יש דרך חכמה, ויש דרך שמבזבזת לכם זמן וכסף 💡\nאנחנו בחרנו בדרך החכמה ואנחנו פה כדי לעזור גם לכם לעשות את אותו הדבר.\n\nבמקום לנסות הכל ולקוות לטוב — בואו נבנה תוכנית שעובדת, עם מטרות ברורות ולוחות זמנים שאפשר לעמוד בהם.\n\nמעניין אתכם? 💬\n← תכתבו לנו ״מעניין״ בתגובות\n\n#טיפים #ערך #עסקיםקטנים #שיווק #צמיחהעסקית #יזמות`,
    `${title}\n\nהדבר הכי חשוב שלמדנו השנה?\nלהקשיב ללקוחות. לא רק לשמוע — להקשיב באמת 👂\nכל שיפור, כל מוצר חדש, כל שירות — נולד מהמילים שלכם.\n\nכשלקוח אומר ״הייתי רוצה ש...״ — אנחנו לא רושמים ושוכחים. אנחנו בונים. וככה נולדו הדברים הכי טובים שעשינו השנה 🙌\n\nספרו לנו — מה הדבר הבא שהייתם רוצים?\n← כתבו בתגובות 👇\n\n#לקוחות #חדשנות #ביחד #שיווק_דיגיטלי #עסקים_בישראל #פידבק`,
  ];
  return seedPick(templates, index);
}
