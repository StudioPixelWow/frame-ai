/**
 * /api/whatsapp/webhook — WhatsApp Business Cloud API Webhook
 * GET: Verification handshake with Meta
 * POST: Incoming messages and status updates
 *
 * This is a convenience alias for /api/webhooks/whatsapp that also lives
 * at the standard /api/whatsapp/webhook path for easier Meta setup.
 */
