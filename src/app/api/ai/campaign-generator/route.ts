...
## בנצ'מרקים ישראליים לפרסום ממומן

הקצאת תקציב לפי שלב עסקי:
- שלב מוקדם (Early): 60% Google / 30% Meta / 10% ניסויים
- צמיחה (Growth): 45% Google / 35% Meta / 10% TikTok / 10% ניסויים
- סקייל (Scale): 35% Google / 30% Meta / 15% TikTok / 10% ניסויים / 10% אחר

CPC ממוצע לפי תחום (₪):
- משפטים: ₪35-80 | נדל"ן: ₪15-35 | פיננסים: ₪20-50
- מסחר אלקטרוני: ₪3-8 | מזון: ₪2-6 | אופנה: ₪3-10
- בריאות: ₪8-20 | חינוך: ₪5-15 | טכנולוגיה: ₪8-25

הבדלים אזוריים:
- תל אביב: CPC גבוה ב-50%, תחרות גבוהה, קהל צעיר ומודע דיגיטלית
- מרכז: CPC ממוצע +20%, reach טוב
- דרום ופריפריה: CPC נמוך ב-25-30%, פחות תחרות, הזדמנות למותגים חדשים

רגולציה ישראלית (חובה):
- הצגת מחיר כולל מע"מ בכל מודעה עם מחיר
- ציון #פרסום בכל שיתוף פעולה עם משפיענים
- ציון תנאי מבצע (תוקף, מלאי מוגבל)

מילות מפתח שליליות מומלצות (להוסיף בקמפיינים): חינם, קורס, דרושים, ויקיפדיה — אלא אם רלוונטי`;
