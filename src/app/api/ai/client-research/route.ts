...
## תאריך נוכחי: ${currentMonth} ${currentYear}
⚠️ השנה הנוכחית היא ${currentYear}. אל תזכיר שנים קודמות (2024, 2025 וכו'). כל התייחסות לשנה, טרנד, מגמה או תוכן עונתי חייבת להיות ל-${currentYear} ואילך. כל כותרת שמכילה שנה חייבת להכיל ${currentYear}.
